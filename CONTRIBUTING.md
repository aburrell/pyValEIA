...
appreciated!  pyValEIA is a community-driven project and welcomes both feedback
and contributions.
...
* Submit bug reports, feature requests, and questions at
  [GitHub](https://github.com/aburrell/pyValEIA/issues)
...
When [reporting a bug](https://github.com/aburrell/pyValEIA/issues)
please include:
...
[issue](https://github.com/aburrell/pyValEIA/issues).
...
2. Clone your fork locally:
  ...
  ```
    git clone git@github.com:your_name_here/pyValEIA.git
  ```
...
3. Create a branch for local development:
  ...
  `git checkout -b name-of-your-bugfix-or-feature`
   ...
   in ``pyValEIA/tests``. For example, custom functions for the grid
   utilities are tested in ``pyValEIA/tests/test_utils_coords.py``.
...
5. You should also check for flake8 style compliance:
   ...
   Note that pyValEIA tests for uniformity in docstring formatting.
...
8. Commit your changes:
   ...
   `pyValEIA` follows the [numpy development workflow](https://numpy.org/doc/stable/dev/development_workflow.html),
...
In general, pyValEIA follows PEP8 and numpydoc guidelines. unittest runs the
...
* The pyVAlEIA logger is imported into each sub-module and provides
